...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[23] = {1620000,  1, 0x1E, 1300000, 1275000, 4},
	[24] = {1674000,  1, 0x1F, 1300000, 1275000, 4},
	[25] = {1728000,  1, 0x20, 1300000, 1282500, 4},
	[26] = {1782000,  1, 0x21, 1300000, 1300000, 4},
};
...
static int __init acpuclk_8x60_init(struct acpuclk_soc_data *soc_data)
{
	...
	for_each_online_cpu(cpu)
		acpuclk_8x60_set_rate(cpu, 1180000, SETRATE_INIT);
