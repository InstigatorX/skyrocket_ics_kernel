...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[23] = {1728000,  1, 0x20, 1300000, 1312500, 5},
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_fast[] = {
  ...
  { {1, 1}, 1566000,  ACPU_SCPLL, 0, 0, 1, 0x1D, L2(22), 1137500, 0x03006000},
  { {1, 1}, 1620000,  ACPU_SCPLL, 0, 0, 1, 0x1E, L2(22), 1150000, 0x03006000},
  { {1, 1}, 1674000,  ACPU_SCPLL, 0, 0, 1, 0x1F, L2(22), 1162500, 0x03006000},
  { {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x20, L2(22), 1175000, 0x03006000},
  { {0, 0}, 0 },
};
*/
